...
var api = new ParseServer({
  ...
  masterKey: process.env.MASTER_KEY || 'brainstorm', //Add your master key here. Keep it secret!
...
app.use('/brainstorm', api);

// Parse Server plays nicely with the rest of your web routes
app.get('/', function(req, res) {
  res.status(200).send('Parse server for Brainstorm :)');
});
